...
//////////////////////////////////////////////////////////////////////////
// Platform specific defines for compatibility Mac/Windows 系统平台兼容Mac/Windows的特定定义说明
#ifdef VDJ_NOEXPORT
...
#include <windows.h>
  #define VDJ_WIN
     ...
     #define VDJ_IS_WIN64 // 如果您需要64位版本的VDJ的特殊代码，请使用此代码
 #endif
...
#define VDJ_WINDOW         void*   // VDJ_Window预计是一个NSWindow
...
//////////////////////////////////////////////////////////////////////////
// Standard structures and defines 标准结构和定义
...
//////////////////////////////////////////////////////////////////////////
// DLL export function DLL导出功能函数（插件的入口点）
